export enum ActionTypes {
  ...
  FAVORITE_ARTICLE = '[Article] favorite Acticle toggle',
  FAVORITE_ARTICLE_SUCCESS = '[Article] favorite Acticle toggle success',
  FAVORITE_ARTICLE_FAILURE = '[Article] favorite Acticle toggle failure',
}

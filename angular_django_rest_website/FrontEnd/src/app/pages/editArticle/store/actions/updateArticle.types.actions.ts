export enum ActionTypes {
  ...
  UPDATE_ARTICLE_FAILURE = '[Update article] Update Article Failed',

  GET_ARTICLE = '[Update article] Get Article',
  GET_ARTICLE_SUCCESS = '[Update article] Get Article Success',
  GET_ARTICLE_FAILURE = '[Update article] Get Article Failed',

  SAVE_ARTICLE = '[Save article] Save Article',
}
